...
export default function TransactionsPage() {
  ...
  const filteredTransactions = transactions.filter((transaction) => {
    ...
    const matchesStatus =
      filterStatus === "All" ||
      transaction.status.toUpperCase() === filterStatus.toUpperCase();
                  ...
                  {paginatedTransactions.map((transaction) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-2">
                        <span className="font-medium text-foreground group-hover:text-[#2F67FA] transition-colors">
                          {transaction.type}
                        </span>
                      </td>
                      <td className="py-4 px-2">
              ...
              {paginatedTransactions.map((transaction) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <p className="font-medium text-foreground text-sm group-hover:text-[#2F67FA] transition-colors">
                        {transaction.type}
                      </p>
                      <span
                        className={cn(
